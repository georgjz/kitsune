...
SOURCES       = src/Main.cpp \
		...
		src/KitsuneTileData.cpp moc_generated/moc_Kitsune.cpp \
		moc_generated/moc_KitsuneImage.cpp
OBJECTS       = obj/Main.o \
		obj/Kitsune.o \
		obj/KitsuneImage.o \
		obj/KitsuneTileData.o \
		obj/moc_Kitsune.o \
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		src/KitsuneTileData.hpp src/Main.cpp \
		src/Kitsune.cpp \
		src/KitsuneImage.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/Kitsune.hpp src/Kitsune.hpp src/KitsuneImage.hpp src/KitsuneTileData.hpp $(DISTDIR)/
	$(COPY_FILE) --parents src/Main.cpp src/Kitsune.cpp src/KitsuneImage.cpp src/KitsuneTileData.cpp $(DISTDIR)/
...
moc_generated/moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	g++ -pipe -g -std=gnu++11 -Wall -W -dM -E -o moc_generated/moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp
...
moc_generated/moc_KitsuneImage.cpp: src/KitsuneTileData.hpp \
		src/KitsuneImage.hpp \
		moc_generated/moc_predefs.h \
		/usr/bin/moc
...
obj/KitsuneTileData.o: src/KitsuneTileData.cpp src/KitsuneTileData.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/KitsuneTileData.o src/KitsuneTileData.cpp
